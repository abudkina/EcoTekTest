...
const UPDATES = {
    ...
    'medicinskie-othody': {
        ...
        shortDescription: 'Обезвреживание медицинских отходов классов Б и В: вывоз, термическое обезвреживание, документы. Москва и МО.'
    },
    'grunt-nefteprodukty': {
...
const NEW_PRODUCTS = [
    {
        ...
        pdfFile: 'docs/Лицензия_Экотек.pdf',
        fullDescription:
...
function main() {
    ...
    order.forEach(function (slug) {
        ...
        p.pdfFile = p.pdfFile || 'docs/Лицензия_Экотек.pdf';
